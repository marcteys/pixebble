...
Pebble.addEventListener('webviewclosed', function(e) {
  ...
  console.log("Got message: " + decodeURIComponent(e.response));

  var config_data = JSON.parse(decodeURIComponent(e.response));
  console.log('Config window returned: ' + JSON.stringify(e.response));
  console.log('config_data userName: ' + config_data.userName);
