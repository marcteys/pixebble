    ...
    * */
    this._dither = function(el) {
        ...
        * */
        ...
        /**
        * Perform a nearest dither on the image
        * */
        this.nearestColor = function(in_imgdata) {
            // Create a new empty image
            var out_imgdata = ctx.createImageData(in_imgdata);
            var d = new Uint8ClampedArray(in_imgdata.data);
            var out = new Uint8ClampedArray(in_imgdata.data);
        ...
        if (self.opt.algorithm == 'nearest')
            var out_image = ditherCtx.nearestColor(in_image);
        else if (self.opt.algorithm == 'errorDiffusion')
        ...
        self.base64Image = ctx.canvas.toDataURL("image/png");
